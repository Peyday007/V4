...
export const DISPOSITIONS: Array<{ value: CallDisposition; label: string; group: string }> = [
  ...
  { value: 'REACHED_RELEVANT_PERSON', label: 'Reached relevant person', group: 'Spoke to someone' },
  { value: 'DECISION_MAKER_IDENTIFIED', label: 'Identified the decision-maker', group: 'Spoke to someone' },
  { value: 'REACHED_DECISION_MAKER', label: 'Reached decision-maker', group: 'Spoke to someone' },
  { value: 'NEED_CONFIRMED', label: 'Need confirmed', group: 'Spoke to someone' },
  { value: 'NEED_UNCONFIRMED', label: 'No need after all', group: 'Spoke to someone' },
  ...
  { value: 'QUOTE_REQUESTED', label: 'Asked for a quote', group: 'Outcome' },
